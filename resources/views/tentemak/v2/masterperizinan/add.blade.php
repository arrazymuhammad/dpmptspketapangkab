                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="section mb10">
                                    ...
                                    <input type="text" name="perizinan" class="form-control" required autocomplete="off">
                                </div>
                                <div class="section mb10">
                                    <label for="" class="control-label">Konten</label>
                                    <textarea name="isi" id="ckeditor1" rows="12" required></textarea>
                                </div>
                            </div>
                        </div>
                        &nbsp;
