        ...
        <div class="allcp-form theme-primary" >
            <div class="panel">
                ...
                <div class="panel-body">
                    <form action="{{ url('/tentemak/inputperizinankeluar') }}" enctype="multipart/form-data"  method="POST">
                        {!!csrf_field()!!}
                        <div class="row">
                            <div class="col-md-12">
                                <div class="section mb10">
                                    <label for="" class="control-label">Array Perizinan</label>
                                    <textarea class="gui-textarea" name="izinnya" required></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
