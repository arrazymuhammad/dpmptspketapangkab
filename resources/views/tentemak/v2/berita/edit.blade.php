        ...
        <div class="allcp-form theme-primary" >
            <div class="panel">
                ...
                <div class="panel-body">
                    <form action="{{ url('/tentemak/updateberita/'.$view->id_berita.'') }}" enctype="multipart/form-data"  method="POST">
                        {!!csrf_field()!!}
                        <div class="row">
                            <div class="col-md-8">
                                <div class="section mb10">
                                    <label for="" class="control-label">Judul Berita</label>
                                    <input type="text" name="judul" class="form-control" required autocomplete="off" value="{{ $view->judul }}">
                                </div>
                                <div class="section mb10">
                                    <label for="" class="control-label">Isi Berita</label>
                                    <textarea name="deskripsi" id="ckeditor1" rows="12" required>{{ $view->deskripsi }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="section mb10">
                                ...
                                <div class="section mb10">
                                    ...
                                    <input type="text" name="tags" class="form-control" required autocomplete="off" value="{{ $view->tags }}">
                                </div>
                            </div>
                        </div>
                        &nbsp;
