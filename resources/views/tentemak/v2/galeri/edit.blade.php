        ...
        <div class="allcp-form theme-primary" >
            <div class="panel">
                ...
                <div class="panel-body">
                    <form action="{{ url('/tentemak/updategaleri/'.$view->id.'') }}" enctype="multipart/form-data"  method="POST">
                        {!!csrf_field()!!}
                        <div class="row">
                            <div class="col-md-8">
                                <div class="section mb10">
                                    <label for="" class="control-label">Judul Berita</label>
                                    <input type="text" name="deskripsi" class="form-control" required autocomplete="off"  value="{{ $view->deskripsi }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="section mb10">
                                    <div class="fileupload-preview thumbnail mb20">
                                        ...
                                        <img src="{{url(''.$view->gambar.'')}}" alt="" style="width: 420px; height: 248px;">
