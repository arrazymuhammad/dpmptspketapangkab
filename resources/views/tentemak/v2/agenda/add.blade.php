        ...
        <div class="allcp-form theme-primary" >
            <div class="panel">
                ...
                <div class="panel-body">
                    <form action="{{ url('/tentemak/inputagenda') }}" enctype="multipart/form-data"  method="POST">
                        {!!csrf_field()!!}
                        <div class="row">
                            <div class="col-md-12">
                                <div class="section mb10">
                                    <label for="" class="control-label">Isi Agenda</label>
                                    <textarea class="gui-textarea" name="agenda"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <input type="text" required="" name="tanggal" placeholder="Tahun/Bulan/Tanggal" class="form-control">
                            </div>
                        </div>
                        &nbsp;
                        <div class="row">
