            ...
            <div class="panel">
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <a href="{{ url('/tentemak/tambahagenda') }}">
                        ...
                        <table class="table table-striped table-hover" id="table_id" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{url('/tentemak/editagenda/'.$var->id.'')}}"><i class="fa fa-edit"></i></a> &nbsp; &nbsp;
                                        <a href="{{url('/tentemak/deleteagenda/'.$var->id.'')}}"><i class="fa fa-trash-o"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
...
@section('js')
    ...
    <script>
        $(document).ready( function () {
            $('#table_id').DataTable({order:[[2,"desc"]]});
        } );
    </script>
