            ...
            <div class="panel">
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <a href="{{ url('/tentemak/halaman/tambah') }}">
                        ...
                        <table class="table table-striped table-hover" id="table_id" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{$var->judul}}</td>
                                    <td>
                                        <a href="{{url('/detailhalaman/'.$var->id.'')}}" target="_blank"><i class="fa fa-eye"></i></a> &nbsp;&nbsp;
                                        <a href="{{url('/tentemak/halaman/edit/'.$var->id.'')}}"><i class="fa fa-edit"></i></a> &nbsp; &nbsp;
                                        <a href="{{url('/tentemak/halaman/delete/'.$var->id.'')}}"><i class="fa fa-trash-o"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
