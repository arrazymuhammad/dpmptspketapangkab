                    ...
                    <div class="large-12 columns">
                        <div class="box bg-white">
                            ...
                            <div class="box-body pad-forty" style="display: block;">
                                ...
                                <hr>
                                <!-- Masked Input -->
                                <form data-abide enctype="multipart/form-data" method="POST" action="{{action('TentemakController@postberita')}}">
                                {!!csrf_field()!!}
                                    <div class="name-field">
                                        <label>Judul Berita
                                            <input type="text" required pattern="[a-zA-Z]+" name="judul">
                                        </label>
                                        <small class="error">Isikan Judul Berita.</small>
                                    </div>
                                    <div class="name-field">
                                        <label>Isi Berita
                                            <textarea id="wiwiq-editor" name="deskripsi" onfocus="this.value='';"></textarea>
                                        </label>
                                        <small class="error">Isikan Isi Berita.</small>
                                    </div>
                                    <div class="name-field">
                                        <label>Tags Berita
                                            <input type="text" required pattern="[a-zA-Z]+" name="tags">
                                        </label>
                                        <small class="error">Isikan Judul Berita.</small>
                                    </div>
                                    <div class="name-field">
