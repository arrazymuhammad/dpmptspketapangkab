                    ...
                    <div class="large-12 columns">
                        <div class="box bg-white">
                            ...
                            <div class="box-body pad-forty" style="display: block;">
                                <h4>Input Galeri</h4>
                                <hr>
                                <form data-abide enctype="multipart/form-data" method="POST" action="{{url('/tentemak/updategaleri/'.$view->id.'')}}">
                                {!!csrf_field()!!}
                                    <div class="name-field">
                                        <label>Judul Gambar
                                            <input type="text" required pattern="[a-zA-Z]+" name="deskripsi" value="{{$view->deskripsi}}">
                                        </label>
