                    ...
                    <div class="large-12 columns">
                        <div class="box bg-white">
                            ...
                            <div class="box-body pad-forty" style="display: block;">
                                ...
                                <hr>
                                <form data-abide action="{{action('TentemakController@postperizinan')}}" method="POST">
                                {!!csrf_field()!!}
                                    <div class="name-field">
                                        <label>Nomor Perizinan
                                            <input type="text" required name="nomer">
                                        </label>
                                    ...
                                    <div class="name-field">
                                        <label>Isi Perizinan
                                            <textarea name="tentang" rows="10"></textarea>
                                        </label>
                                    ...
                                    <div class="row collapse">
                                        ...
                                        <div class="small-9 columns">
                                            <input type="text" required name="tgl_surat" id="date" />
                                        </div>
