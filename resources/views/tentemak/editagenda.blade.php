                    ...
                    <div class="large-12 columns">
                        <div class="box bg-white">
                            ...
                            <div class="box-body pad-forty" style="display: block;">
                                <h4>Edit Agenda</h4>
                                <hr>
                                <form data-abide action="{{url('/tentemak/updateagenda/'.$view->id.'')}}" method="POST">
                                {!!csrf_field()!!}
                                    ...
                                    <div class="row collapse">
                                        <label>Tanggal Agenda</label>
                                            <input type="text" required name="tanggal" placeholder="Tahun/Bulan/Tanggal" value="{{$view->tanggal}}"/>
                                        </label>
