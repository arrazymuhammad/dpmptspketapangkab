                    ...
                    <div class="large-12 columns">
                        <div class="box bg-white">
                            ...
                            <div class="box-body pad-forty" style="display: block;">
                                <h4>Input User</h4>
                                <hr>
                                <form data-abide action="{{url('/tentemak/updateuser/'.$view->id.'')}}" method="POST">
                                {!!csrf_field()!!}
                                    <div class="name-field">
                                        <label>Nama User
                                            <input type="text" required name="name" value="{{$view->name}}">
                                        </label>
                                        <small class="error">Isikan Nama User.</small>
                                    </div>
                                    <div class="name-field">
                                        <label>E-mail User
                                            <input type="email" required name="email" value="{{$view->email}}">
                                        </label>
